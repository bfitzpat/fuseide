...
public class ReloadTransformationWizard extends Wizard {
    ...
    private org.jboss.tools.fuse.transformation.core.model.Model genModel = null;
    ...
    public void setModel(org.jboss.tools.fuse.transformation.core.model.Model inModel) {
    	genModel = inModel;
